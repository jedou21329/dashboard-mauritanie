...
        fig.update_layout(
            title={
                'text': "Croissance du PIB – cycles économiques et chocs
<sub>Source : BCM, FMI, Banque Mondiale</sub>",
...
        fig.update_layout(
            title={
                'text': "Inflation – régimes macroéconomiques
<sub>Source : BCM, FMI</sub>",
                'font': {'size': 16, 'color': '#0B3C5D', 'family': 'Inter'}
            },
            xaxis_title="", yaxis_title="%",
            hovermode='x unified',
...
       
        fig.update_layout(
            title="Indicateurs macroéconomiques – moyennes par décennie
<sub>Source: Calculs propres</sub>",
...
            fig.update_layout(
                title="Croissance du PIB – cycles économiques
<sub>Source: BCM, FMI</sub>",
...
           
            fig.update_layout(
                title="Croissance du PIB – volatilité et incertitude
<sub>Source: Banque Mondiale</sub>",
...
                hovertemplate='Année: %{text}
Chômage: %{x:.1f}%
Inflation: %{y:.1f}%<extra></extra>'
            ))
            fig.update_layout(
                title="Courbe de Phillips – Mauritanie (2007–2021)
<sub>Source: BCM</sub>",
...
           
            fig.update_layout(
                title="Distribution de la croissance du PIB par période
<sub>Source: Banque Mondiale</sub>",
...
       
        fig.update_layout(
            title="Soutenabilité externe : dette vs réserves
<sub>Source: Banque Mondiale</sub>",
...
            textposition='outside',
            hovertemplate='<b>%{x}</b>
Chômage: %{y:.1f}%<extra></extra>'
        ))
        fig.update_layout(
            title="Croissance économique et chômage (2007–2021)
<sub>Source: BCM</sub>",
...
Corrélation: %{z:.2f}<extra></extra>'
            ))
            fig.update_layout(
                title="Corrélations entre indicateurs macroéconomiques (2007–2024)
<sub>Source: Calculs propres</sub>",
                height=500
            )
            st.plotly_chart(fig, use_container_width=True, config=plotly_config)
...
Inflation: %{x:.1f}%
Chômage: %{y:.1f}%
Croissance: %{z:.1f}%<extra></extra>'
            ))
            fig.update_layout(
                title="Trajectoire macroéconomique 3D (depuis 2000)
<sub>Source: Calculs propres</sub>",
                scene=dict(
...
            ))
            fig.update_layout(
                title="Pression macroéconomique : inflation et chômage
<sub>Source: BCM, FMI</sub>",
...
           
            fig.update_layout(
                title="Régimes macroéconomiques (Inflation vs Croissance)
<sub>Source: Calculs propres</sub>",
                xaxis_title="Inflation (%)",
                yaxis_title="Croissance (%)",
